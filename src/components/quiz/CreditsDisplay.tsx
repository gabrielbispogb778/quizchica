...
export const CreditsDisplay = ({ credits }: CreditsDisplayProps) => {
  ...
  return (
    <div 
      className="fixed top-1 right-1 md:top-4 md:right-4 z-50 flex items-center gap-0.5 md:gap-2 rounded md:rounded-lg px-1.5 py-0.5 md:px-3 md:py-2 transition-all duration-500"
      style={{
    ...
    >
      <span 
        className="text-[10px] md:text-sm font-medium transition-all duration-500"
        style={{ 
          color: color,
      ...
      >
        ...
        <span 
          className="font-bold text-[10px] md:text-sm transition-all duration-500"
          style={{ 
            color: color,
            textShadow: `0 0 4px ${color}CC`,
          }}
