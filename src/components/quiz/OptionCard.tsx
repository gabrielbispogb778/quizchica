...
export const OptionCard = ({ label, image, onClick, className }: OptionCardProps) => {
  return (
    <button
      onClick={onClick}
      className={cn(
        "group w-full max-w-[360px] overflow-hidden rounded-xl",
    ...
    >
      ...
      <div className="h-14 sm:h-16 bg-primary flex items-center justify-center px-4">
        <p className="text-foreground text-sm sm:text-base font-bold text-center leading-tight line-clamp-2">
          {label}
        </p>
      </div>
