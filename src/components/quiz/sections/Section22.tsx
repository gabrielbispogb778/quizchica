...
export const Section22 = ({ onSelect, onBack }: Section22Props) => {
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-black flex flex-col overflow-y-auto">
      {/* Fixed Red Banner */}
      {showBanner && (
        <div className="fixed top-0 left-0 right-0 z-40 bg-gradient-to-r from-red-700 via-red-600 to-red-700 py-1.5 px-2 sm:py-2 sm:px-3 md:py-3 md:px-4 shadow-lg animate-fade-in border-b-2 border-yellow-400">
          <p className="text-white text-[10px] sm:text-xs md:text-base font-black text-center tracking-wide sm:tracking-widest leading-tight uppercase animate-[pulse_1.5s_ease-in-out_infinite] drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
          ...
          {spotsLeft <= 10 && (
            <p className="text-yellow-100 text-[7px] sm:text-[9px] md:text-xs text-center mt-0.5 sm:mt-1 font-semibold leading-tight drop-shadow-[0_1px_1px_rgba(0,0,0,0.5)]">
