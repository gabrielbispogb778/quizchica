      ...
      <div className="flex-1 flex flex-col items-center px-3 pt-6 pb-8 sm:px-4 sm:pt-8">
        ...
        <div className="w-full max-w-xs sm:max-w-md mt-4 sm:mt-6">
          ...
          <div className="mt-4 sm:mt-6 w-full">
            ...
            {/* Green CTA Button */}
            <a href="https://go.centerpag.com/PPU38CQ78AI" target="_blank" rel="noopener noreferrer" className="w-full bg-[#22c55e] hover:bg-[#16a34a] text-white text-sm sm:text-lg font-bold py-3 sm:py-4 px-4 sm:px-6 rounded-xl transition-colors active:scale-[0.98] block text-center">
          ...
          <div className="w-full max-w-xs sm:max-w-md mt-6 sm:mt-8">
            ...
            <div className="bg-transparent border border-[#444] rounded-lg p-3 sm:p-4 mb-2">
              <p className="text-white text-sm sm:text-base font-bold text-center mb-2">We Guarantee 100% of Your Refund</p>
              <p className="text-white text-xs sm:text-sm text-center leading-relaxed mb-3">We believe so much in our techniques that we are willing to refund your money if you don't get results, but I tell you, to this day we have never had a single refund!</p>
              <p className="text-white text-xs sm:text-sm text-center leading-relaxed font-semibold">Follow exactly as we teach, and it's impossible not to get the result you want, we guarantee it!</p>
            </div>
            ...
            <div className="w-full mt-8 sm:mt-10">
              ...
              <a href="https://go.centerpag.com/PPU38CQ78AI" target="_blank" rel="noopener noreferrer" className="w-full bg-[#22c55e] hover:bg-[#16a34a] text-white text-xs sm:text-base font-bold py-3 sm:py-4 px-3 sm:px-4 rounded-xl transition-colors active:scale-[0.98] block text-center">
