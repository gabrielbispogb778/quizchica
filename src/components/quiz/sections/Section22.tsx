...
export const Section22 = ({ onSelect, onBack }: Section22Props) => {
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-black flex flex-col overflow-y-auto">
      {/* Fixed Red Banner */}
      {showBanner && (
        <div className="fixed top-0 left-0 right-0 z-40 bg-[#dc2626] py-2 px-3 sm:py-2.5 sm:px-4 shadow-lg animate-fade-in">
          <p className="text-white text-[10px] sm:text-xs md:text-sm font-bold text-center tracking-wide leading-tight">
