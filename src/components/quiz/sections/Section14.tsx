  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-[#000000] flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center px-3 pt-6 pb-8 sm:px-4 sm:pt-8">
        ...
        {/* Title */}
        <h1 className="text-white text-lg sm:text-xl md:text-2xl font-bold text-center mb-2 max-w-sm sm:max-w-md px-2">
        ...
        <div className="w-full max-w-xs sm:max-w-lg mb-4 sm:mb-6">
          <div className="bg-[#D92B27] rounded-lg p-2 sm:p-4">
            <div 
