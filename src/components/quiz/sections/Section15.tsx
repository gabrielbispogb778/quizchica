...
export const Section15 = ({
  ...
  return <div className="min-h-screen bg-[#000000] flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center px-4 pt-8 pb-8">
        ...
        {/* Image */}
        <div className="mb-8">
          <img src={secao15Imagem} alt="Couple illustration" className="w-64 sm:w-80 h-auto object-contain" />
        </div>

        {/* Continue Button */}
        <button onClick={e => onSelect(e)} className="w-full max-w-sm bg-[#D92B27] hover:bg-[#B82422] text-white font-bold py-4 px-6 rounded-lg transition-all duration-200">
          Continue
        </button>
      </div>
    </div>;
